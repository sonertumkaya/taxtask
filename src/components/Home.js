...
<div className="match-height row"><div class="col-12 col-md-6 col-xl-4">
<div className="card-congratulations-medal card">
<div className="card-body"><h5>Tamamlanmış layihələrin sayı</h5><p class="font-small-3 card-text"></p>
